...
public class CustomerService {
    ...
    public Customer initCustomer(Customer customer) {
        ...
        CustomerEntity savedEntity = customerRepository.save(customerToCustomerEntityMapper.toCustomerEntity(customer));
        return customerToCustomerEntityMapper.toCustomer(savedEntity);
    }
}
